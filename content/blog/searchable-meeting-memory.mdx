...
Your meeting data stays in your account. Searches are scoped to your meetings and your documents. There's no cross-user data sharing, no training on your transcripts, and no access without authentication.

You control how long data is retained. When you delete a meeting, its transcript, embeddings, and any associated documents are removed from the system.

## Getting started

There's no setup for meeting memory — it happens automatically. Every call that Vernix joins becomes part of your searchable archive. The more calls you take, the richer the memory becomes.

Start with your next meeting. After the call, try searching for something that was discussed. You'll see the difference between "I think someone mentioned that" and "here's exactly what was said, with the source."
